...
export default function Shop() {
  ...
  overflow: "hidden"}} className="">
                salam Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Aut molestias fugit quia, impedit veritatis eaque, quis dolore
                voluptatibus delectus deserunt culpa consequuntur porro officiis
                officia, expedita quasi quidem sunt cumque!
              </div>
              <div>
              خلاصه                
              </div>
