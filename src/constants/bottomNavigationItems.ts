...
const BottomNavigationItems = <INavigationItem[]>[
    { title: 'خانه', Icon: HomeIcon, route: PATH_DASHBOARD.navigator.home , iconProps: { sx: { gridArea: 'home' , color: "" } } },
    { title: 'جستجو', Icon: Search, route: PATH_DASHBOARD.navigator.search },
    { title: 'دانلود', Icon: GetAppIcon, route: PATH_DASHBOARD.root },
    { title: 'تاریخچه', Icon: AccessTime, route: PATH_DASHBOARD.navigator.profile },
]
