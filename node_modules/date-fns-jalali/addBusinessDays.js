...
var _index6 = require("./_core/getDate.js");
var _index7 = require("./_core/setDate.js");
...
function addBusinessDays(date, amount) {
  ...
  (0, _index7.setDate)(_date, (0, _index6.getDate)(_date) + fullWeeks * 7);
  ...
  while (restDays > 0) {
    (0, _index7.setDate)(_date, (0, _index6.getDate)(_date) + sign);
  ...
  if (startedOnWeekend && (0, _index4.isWeekend)(_date) && amount !== 0) {
    ...
    if ((0, _index2.isSaturday)(_date))
      (0, _index7.setDate)(
        _date,
        (0, _index6.getDate)(_date) + (sign < 0 ? 2 : -1),
      );
    if ((0, _index3.isSunday)(_date))
      (0, _index7.setDate)(
        _date,
        (0, _index6.getDate)(_date) + (sign < 0 ? 1 : -2),
      );
  }
