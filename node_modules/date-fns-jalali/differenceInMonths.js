...
var _index5 = require("./_core/getMonth.js");
var _index6 = require("./_core/setMonth.js");
var _index7 = require("./_core/getDate.js");
var _index8 = require("./_core/setDate.js");
...
function differenceInMonths(dateLeft, dateRight) {
  ...
  if (difference < 1) {
    ...
    if (
      (0, _index5.getMonth)(_dateLeft) === 11 &&
      (0, _index7.getDate)(_dateLeft) > 28
    ) {
      // This will check if the date is end of Esfand and assign a higher end of month date
      // to compare it with Farvardin
      (0, _index8.setDate)(_dateLeft, 30);
    }

    (0, _index6.setMonth)(
      _dateLeft,
      (0, _index5.getMonth)(_dateLeft) - sign * difference,
    );
