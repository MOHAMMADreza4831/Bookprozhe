      ...
      <div className="px-2 py-2  -slate-100 ">
        {basket?.map((book: Book) => (
          ...
          >
            ...
            <div>
              salam
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut molestias fugit quia, impedit veritatis eaque, quis dolore voluptatibus delectus deserunt culpa consequuntur porro officiis officia, expedita quasi quidem sunt cumque!
              </div>
          </div>
        ))}
      </div>
