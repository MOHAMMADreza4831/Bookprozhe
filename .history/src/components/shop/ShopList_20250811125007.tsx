...
export default function Shop() {
  ...
  const {
    ...
    queryKey: ["books"],
    queryFn: () => axioshandel.get("/basket").then((res) => res.),
  });
    ...
    <>
      ...
      <div className="px-2 py-2 bg-slate-100 ">
        {books && books.map((book:Book) => (
          ...
          >
            <div className="flex items-center pt-2 pb-16 pr-2">
              <img
                src={book.image}
            ...
            <div className="flex flex-col justify-center px-2 py-2">
              <div>
                <p className="line-clamp-2">{book.AbotBook}</p>
              </div>
              <Divider variant="middle" sx={{ color: "#B3B3B3" }} />
              <div className="flex flex-col justify-center gap-2 mt-2">
                <div className="flex gap-2 flex-col  ">
                </div>
                <div
                  className="flex flex-row-reverse justify-between p-2"
