...
import { setMonth as coreSetMonth } from "./_core/setMonth.mjs";
import { getDate as coreGetDate } from "./_core/getDate.mjs";
import { setDate as coreSetDate } from "./_core/setDate.mjs";
...
export function differenceInMonths(dateLeft, dateRight) {
  ...
  if (difference < 1) {
    ...
    if (coreGetMonth(_dateLeft) === 11 && coreGetDate(_dateLeft) > 28) {
